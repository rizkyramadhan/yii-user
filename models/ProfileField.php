...
class ProfileField extends CActiveRecord {
    ...
    const VISIBLE_ALL = 4;
    const VISIBLE_FOR_CERTAIN_ROLE = 3;
    ...
    public function attributeLabels() {
        return array(
            ...
            'visible_for_role' => UserModule::t('Role')
        );
    }
    ...
    public static function itemAlias($type, $code = NULL) {
        $_items = array(
            ...
            'visible' => array(
                ...
                self::VISIBLE_FOR_CERTAIN_ROLE => UserModule::t('For certain role'),
    ...
    public function search() {
        ...
        $criteria->compare('visible_for_role', $this->visible_for_role);
